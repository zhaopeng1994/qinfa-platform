...
import com.qinfagroup.platform.generator.entity.mongo.MongoGeneratorEntity;
...
public class GenUtils {
    ...
    public static Map<String, String> getSuperClassFields(String className) {
        Map<String, String> fieldMap = new HashMap<>();
        try {
            Class<?> clazz = Class.forName(className);
            Field[] declaredFields = clazz.getDeclaredFields();
            for (Field declaredField : declaredFields) {
                fieldMap.put(declaredField.getName(), declaredField.getGenericType().getTypeName());
            }
    ...
    public static String getFileName(String template, String className, String packageName, String moduleName) {
        ...
        if (template.contains("index.vue.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src" + File.separator + "views" + File.separator + "modules" +
                    File.separator + moduleName + File.separator + StringUtils.uncapitalize(className) + ".vue";
        }

        if (template.contains("add-or-update.vue.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src" + File.separator + "views" + File.separator + "modules" +
                    File.separator + moduleName + File.separator + StringUtils.uncapitalize(className) + "-add-or-update.vue";
        }
